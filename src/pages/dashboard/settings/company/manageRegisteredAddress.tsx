...
const ManageRegisteredAddress = () => {
  ...
  useEffect(() => {
    if (savedAddress) {
      setAddress((prev) => ({ ...prev, ...savedAddress.registeredAddress }));
    }
  }, []);
  ...
  const handleSave = (e: FormEvent) => {
    ...
    if (selectedCountry) {
      setLoading(true);
      updateAddressData("registeredAddress", {
        ...address,
        country: {
  ...
  return (
    <div className=" bg-gray-100 dark:bg-gray-600">
      <TitleHeader title="Registered address" isBackButton isTabs />
...
export default ManageRegisteredAddress;
