...
const getContractBadge = (contractType: TimeSheetRecord["contract"]["contractType"]) => {
  switch (contractType) {
    case "Fixed rate":
      return `border-primary-200 bg-primary-500 text-primary-200 dark:bg-yellow-900 dark:text-yellow-300`;
    case "Pay as you go":
      return `border-error-500 bg-error-400 text-error-500 dark:bg-red-900 dark:text-red-300`;
    case "Milestone":
      return `border-info-300 bg-info-500 text-info-300 dark:bg-green-900 dark:text-green-300`;
    default:
      return "";
  }
};
...
function OverviewTabContent() {
  ...
  const payrollColumns: TableColumn[] = [
    ...
    { key: "contractType", header: "Contract Type", align: "right" },
    { key: "amount", header: "Amount", align: "center" },
    { key: "paidIn", header: "Paidin", align: "center" },
    { key: "nextPayoutDate", header: "Time Stamp", align: "right" },
  ];
