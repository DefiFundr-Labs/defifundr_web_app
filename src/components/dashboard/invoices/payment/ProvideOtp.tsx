  ...
  return (
    <>
      <div className="text-center max-w-3/4 w-full mx-auto">
        <h3 className="font-semibold text-xl lg:font-bold lg:text-3xl text-gray-500 dark:text-gray-150 mb-4 lg:mb-2">
          Provide OTP
        </h3>
        ...
        >
          ...
          <span className="text-gray-500 dark:text-gray-150">OTP</span> sent to
