...
interface TwoFAOtpProps {
  length?: number;
  onComplete?: (otp: string) => void;
  isResendOtp?: boolean;
}

const TwoFAOtp: React.FC<TwoFAOtpProps> = ({
  length = 6,
  onComplete = () => {},
  isResendOtp = false,
}) => {
  ...
  return (
    <div className="space-y-6">
        ...
        {otp.map((digit, index) => (
          <div key={index} className="relative">
            <input
              ...
              onPaste={handlePaste}
              className={`otp-input w-full  peer dark:!bg-gray-500 h-18  ${
      ...
      {/* Resend OTP option */}
      {isResendOtp && (
        <div className="otp-resend-container border-0 p-0 gap-1 mx-auto">
