...
export const HeroSection = () => {
  return (
    <div className="relative hidden h-full w-full bg-gradient-to-br from-purple-900 via-blue-900 to-black md:block lg:block">
      <div
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-purple-900/50 via-blue-900/50 to-black" />
